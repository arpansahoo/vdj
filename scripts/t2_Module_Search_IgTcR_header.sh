...
#SBATCH --output=/work/pi_gblanck/Arpan/NBL_WXS/SLURM_OUTPUT/output-t2.%j
...
############################################################################################################################
#set file paths
bamFolder="/work/pi_gblanck/Arpan/NBL_WXS/NBL_BAMS"
...
email="placeholder@aot.com"
############################################################################################################################

module load apps/samtools/1.3.1
source /work/pi_gblanck/Arpan/NBL_WXS/scripts/t2_Module_Search_IgTcRFix.sh
